// Fig. 6.8: Scope.java - Scope class demonstrates field and local variable scopes.
...
public class Scope 
{
	...
	{
		int x = 25; // initialized each time useLocalVariable is calles
		
		System.out.printf(
				"\nlocal x on entering method useLocalVariable is %d\n", x);
		++x; // modifies this method's local variable x
		System.out.printf(
				"\nlocal x be exiting method useLocalVariable is %d\n", x);
