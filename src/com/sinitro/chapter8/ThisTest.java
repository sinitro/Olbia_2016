// Fig. 8.4: This.java - this used implicitly and explicitly to refer to member of an object
...
// class SimpleTime demnostrates this "this" reference
class SimpleTime
{
	...
	// if the constructor uses parameters names identical to
