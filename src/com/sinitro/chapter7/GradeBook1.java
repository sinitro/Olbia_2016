// Fig. 7.18: GradeBook1.java - GradeBook class using a two-dimensional array to store grades. 
...
public class GradeBook1 
{
	...
	public int getMaximum()
	{
		...
		for (int[] studentGrades : grades)
		{
			...
			for (int grade : studentGrades)
			{
				// if grade greater than higGrade, assign it to highGrade
				if (grade > highGrade)
					highGrade = grade;
			} // end inner for
		} // end outer for
	...
	public void outputBarChart()
	{
		...
		// for each grade in GradeBook1, increment the appropriate frequency
		for (int[] studentGrades : grades)
		{
			for (int grade : studentGrades)
				++frequency[grade / 10];			
